...
export const ProjectItem = ({
  ...
  return (
    <li key={todo.id} onClick={previewHandler} className="userproject project">
      <input
        type="text"
      ...
      {/* Deletes projects from the todolist */}
      <button id="delete-project__btn" onClick={() => deleteHandler(todo)}>
        <svg
